...
var file_echo_proto_rawDesc = []byte{
	...
	0x68, 0x6f, 0x22, 0x2a, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71,
	...
	,
}
...
var file_echo_proto_goTypes = []interface{}{
	(*MessageRequest)(nil), // 0: echo.MessageRequest
	(*MessageReply)(nil),   // 1: echo.MessageReply
}
var file_echo_proto_depIdxs = []int32{
	0, // 0: echo.EchoService.Echo:input_type -> echo.MessageRequest
	1, // 1: echo.EchoService.Echo:output_type -> echo.MessageReply
...
func (c *echoServiceClient) Echo(ctx context.Context, in *MessageRequest, opts ...grpc.CallOption) (*MessageReply, error) {
...
func (*UnimplementedEchoServiceServer) Echo(context.Context, *MessageRequest) (*MessageReply, error) {
...
func _EchoService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EchoServiceServer).Echo(ctx, req.(*MessageRequest))
	}
